/****************************************************************************
** Meta object code from reading C++ file 'Observer.hh'
**
** Created: Wed Mar 5 14:25:44 2014
...
#error "The header file 'Observer.hh' doesn't include <QObject>."
...
static const char qt_meta_stringdata_Observer[] = {
    "Observer\0\0change_room_slot()\0"
};
...
void Observer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->change_room_slot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Observer::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Observer,
